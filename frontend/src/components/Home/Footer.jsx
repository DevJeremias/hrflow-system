      ...
      <div className="footer-container">
        <div className="footer-brand">
          ...
          <p className="footer-description">
            A plataforma mais completa para transformar a gestão de pessoas da
            sua empresa.
          </p>
          <div className="footer-contact-info">
            <a href="mailto:contato@sistemarh.com.br" className="contact-link">
              ✉ contato@sistemarh.com.br
            </a>
            <span className="contact-link">📞 (11) 3000-0000</span>
            <span className="contact-link">📍 São Paulo, SP</span>
          </div>
        </div>

        <div className="footer-social-middle">
          <h4 className="footer-title center-text">Siga-nos</h4>
          <div className="social-links">
            <a href="#linkedin" className="social-item" aria-label="LinkedIn">
            ...
            <a href="#instagram" className="social-item" aria-label="Instagram">
              <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="#facebook" className="social-item" aria-label="Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="#x" className="social-item" aria-label="X">
              <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-links-wrapper">
          <div className="footer-column">
            <h4 className="footer-title">Produto & Empresa</h4>
          ...
          <div className="footer-column">
            <h4 className="footer-title">Recursos & Legal</h4>
            <ul className="footer-list">
              <li>
