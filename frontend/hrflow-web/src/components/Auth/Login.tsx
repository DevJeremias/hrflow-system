      ...
      <div className="hidden lg:flex flex-[1.4] relative bg-[#0a0f1d]">
        ...
        <div className="relative z-10 flex flex-col justify-between w-full h-full pt-12 pb-12 pl-10 pr-12 xl:pt-16 xl:pb-16 xl:pl-20">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-primary p-2.5 rounded-xl shadow-lg shadow-orange-500/20">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex justify-end pt-0">
              <a href="#" className="text-sm font-bold text-primary hover:text-orange-700 transition-colors">
                Esqueceu a senha?
              </a>
            </div>
            ...
            <button 
              ...
              className="w-full py-5 bg-primary hover:bg-orange-300 disabled:bg-primary/70 text-white font-extrabold text-lg rounded-2xl shadow-xl shadow-orange-100 hover:shadow-orange-200 transition-all transform active:scale-[0.98] mt-2 flex justify-center items-center gap-2"
            >
              {isSubmitting ? (
                <>
