...
export default function CommandCenter() {
  return (
    <section className="py-32 bg-slate-900 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-orange-600/20 blur-[150px] rounded-full" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="relative h-[500px] md:h-[600px] flex items-center justify-center">
          ...
          <div className="absolute w-full max-w-2xl bg-white p-10 md:p-16 rounded-[3rem] shadow-2xl shadow-orange-900/50 transform group hover:scale-105 transition-transform duration-700">
            <div className="flex items-center gap-6 mb-8">
              <div className="w-16 h-16 bg-orange-600 rounded-2xl flex items-center justify-center text-white">
                <Layers size={32} />
              </div>
              <div>
          ...
          <div className="absolute top-10 right-20 animate-bounce-slow text-orange-400 hidden lg:block"><MousePointer2 size={48} /></div>
