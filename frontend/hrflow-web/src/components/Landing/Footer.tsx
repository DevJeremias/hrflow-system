        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 mb-24">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-black tracking-tighter">RH<span className="text-orange-500">PRO</span></span>
            </div>
            ...
            <div className="flex gap-5">
              {[Instagram, Linkedin, Twitter, Github].map((Icon, i) => (
                <a key={i} href="#" className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-orange-600 hover:text-white transition-all text-slate-400">
                  <Icon size={20} />
                </a>
              ))}
            </div>
          ...
          <div className="space-y-8">
            <h4 className="text-xs font-black text-orange-500 uppercase tracking-[0.2em]">Produto</h4>
          ...
          <div className="space-y-8">
            <h4 className="text-xs font-black text-orange-500 uppercase tracking-[0.2em]">Newsletter</h4>
            <p className="text-slate-400 font-medium">Receba insights semanais sobre o futuro do trabalho.</p>
            <div className="relative group">
              <input 
                type="email" 
                placeholder="Seu melhor e-mail" 
                className="w-full bg-white/5 border border-white/10 p-5 rounded-2xl outline-none focus:border-orange-600 focus:bg-white/10 transition-all font-bold"
              />
              <button className="absolute right-2 top-2 bottom-2 bg-orange-600 hover:bg-orange-500 px-6 rounded-xl font-black text-sm transition-all active:scale-95">
                OK
              </button>
            </div>
          </div>
