      ...
      <div className="flex items-center gap-3 md:gap-6">
        ...
        <div className="flex items-center gap-3 cursor-pointer group">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-xs font-medium text-slate-500">Gestor de RH</p>
          </div>
          <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-orange-500 to-primary flex items-center justify-center text-white font-bold shadow-md group-hover:shadow-lg transition-all">
