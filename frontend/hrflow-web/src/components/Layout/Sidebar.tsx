      ...
      `}>
        ...
        <div className="p-5 border-t border-slate-800/50">
          <div className="flex items-center gap-3 px-4 py-3 mb-3 rounded-2xl bg-white/5 border border-white/10">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-orange-500 to-primary flex items-center justify-center text-white font-bold shadow-inner uppercase">
