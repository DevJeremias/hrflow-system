          ...
          <div className="space-y-6">
            <div className="flex flex-wrap gap-2 pb-2">
              <button 
                ...
                className={`px-5 py-2 rounded-full text-xs font-black border transition-all ${roleFilter === 'Todos' ? 'bg-primary border-primary text-white shadow-lg shadow-orange-100' : 'bg-white border-slate-200 text-slate-500 hover:border-primary'}`}
              >
                Todos ({roles.length})
              </button>
              {departments.map(dept => (
                <button 
                  ...
                  className={`px-5 py-2 rounded-full text-xs font-black border transition-all ${roleFilter === dept.sigla ? 'bg-primary border-primary text-white shadow-lg shadow-orange-100' : 'bg-white border-slate-200 text-slate-500 hover:border-primary'}`}
                >
