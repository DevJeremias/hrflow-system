    ...
    <div className="bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40 p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
      <div className="flex justify-between items-start mb-6">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-orange-50 text-primary flex items-center justify-center shadow-inner">
            <Building2 size={24} />
          </div>
          <div>
        ...
        <div className="flex gap-1">
          <button onClick={onEdit} className="p-2 text-slate-400 hover:text-primary hover:bg-orange-50 rounded-xl transition-all">
            <Pencil size={18} />
          </button>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-slate-100">
        ...
        <span className="text-xs font-bold text-primary bg-orange-50 px-3 py-1 rounded-lg">
